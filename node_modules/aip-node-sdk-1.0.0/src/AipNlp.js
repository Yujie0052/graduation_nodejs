...
const PATH_NLP_SIMNET  = '/rpc/2.0/nlp/v1/simnet';
...
class AipNlp extends BaseClient {
    ...
    simnet(query1, query2) {
        let promise = this.registTask(this.simnetImpl, {
            input: {
                qslots: [{terms_sequence: query1, type: 0, items: []}],
                tslots: [{terms_sequence: query2, type: 0, items: []}]
            }
        });
        return promise;
    }
